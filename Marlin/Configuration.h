...
#define STRING_CONFIG_H_AUTHOR "Miguel Risco-Castillo (MRiscoC) - CR-Touch G29 Auto-Level" // Original author or contributor.
...
#define ENABLE_LEVELING_AFTER_G28  // Auto-enable leveling after G28
